<?php
/**
 * Title: Video Noise Hero
 * Slug: custom/video-noise
 * Categories: custom/custom-patterns
 * Description: Hero sekcja z video tłem, animowanym noise overlay i centralnym logo
 * Keywords: video, noise, hero, logo, animation, custom
 */
?>
...
<video autoplay loop muted src="http://localhost/bedrock/web/app/uploads/2025/09/fQM1RaSPcHPbMZR0PCsoGur0U.mp4" playsinline></video>
</figure>
<!-- /wp:video -->
...
<img src="http://localhost/bedrock/web/app/uploads/2025/09/logo.svg" alt="" class="wp-image-72"/>
</figure>
<!-- /wp:image -->

<!-- wp:image {"id":73,"sizeSlug":"full","linkDestination":"none","className":"hero-noise"} -->
<figure class="wp-block-image size-full hero-noise">
<img src="http://localhost/bedrock/web/app/uploads/2025/09/noise.png" alt="" class="wp-image-73"/>
</figure>
<!-- /wp:image -->
